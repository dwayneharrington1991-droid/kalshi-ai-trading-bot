...
export OVERNIGHT_CANARY_MAX_TOTAL_RISK="5"
export OVERNIGHT_CANARY_MAX_MARKET_RISK="1"
export OVERNIGHT_CANARY_MAX_POSITIONS="5"
export OVERNIGHT_CANARY_MAX_REJECTIONS="3"
export OVERNIGHT_CANARY_MAX_DAILY_LOSS="2"
...
[[ "$OVERNIGHT_CANARY_MAX_TOTAL_RISK" == "5" \
   && "$OVERNIGHT_CANARY_MAX_MARKET_RISK" == "1" \
   && "$OVERNIGHT_CANARY_MAX_POSITIONS" == "5" \
   && "$OVERNIGHT_CANARY_MAX_REJECTIONS" == "3" \
   && "$OVERNIGHT_CANARY_MAX_DAILY_LOSS" == "2" \
